...
public class Ventana extends JFrame implements ActionListener {
	...
	public Ventana() {
		...
		// INICIO
		JPanelBackground panele = new JPanelBackground();

		panele.setOpaque(false);
		panele.setBackground("img/bc.png");

		add(panele, BorderLayout.CENTER);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (event.equals("Registrar Usuario")) {
			...
			this.getContentPane().add(panelBotones, BorderLayout.WEST);
			...
			asd.enableDefaultValue(Actividades, "Actividad1,Actividad2,Actividad3...");
			...
			asd.enableDefaultValue(HoraFin, "HH:mm:");
			asd.enableDefaultValue(HoraInicio, "HH:mm");
			asd.enableDefaultValue(FechaIn5, "dd-MM-yyyy");
			asd.enableDefaultValue(FechaFin5, "dd-MM-yyyy");
			...
			this.getContentPane().add(panel6, BorderLayout.CENTER);
			this.getContentPane().add(panelBotones, BorderLayout.WEST);
			getContentPane().revalidate();
			getContentPane().repaint();
			...
			this.getContentPane().add(panel8, BorderLayout.CENTER);
			this.getContentPane().add(panelBotones, BorderLayout.WEST);
			getContentPane().revalidate();
			getContentPane().repaint();
			...
			if (elProyecto != null)
			{
				...
				this.getContentPane().add(panel41, BorderLayout.CENTER);
				this.getContentPane().add(panelBotones, BorderLayout.WEST);
				...
				this.getContentPane().add(panel42, BorderLayout.CENTER);
				this.getContentPane().add(panelBotones, BorderLayout.WEST);
				getContentPane().revalidate();
				getContentPane().repaint();
			}
			...
			if (elProyecto != null)
			{
				...
				this.getContentPane().add(panel51, BorderLayout.CENTER);
				this.getContentPane().add(panelBotones, BorderLayout.WEST);
				getContentPane().revalidate();
				getContentPane().repaint();
				...
				this.getContentPane().add(panel52, BorderLayout.CENTER);
				this.getContentPane().add(panelBotones, BorderLayout.WEST);
				getContentPane().revalidate();
				getContentPane().repaint();
			}
